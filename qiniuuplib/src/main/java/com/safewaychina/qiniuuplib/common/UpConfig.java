...
public class UpConfig {
    //分片大小
    public static int CHUNK_SIZE = 100 * 1024;
    //分块大小
    ...
    //表单和分块host地址
    public static final String FORM_HOST = "http://upload.qiniu.com/";
    public static final String BLOCK_HOST = "http://upload.qiniu.com/";
    //失败重传次数
